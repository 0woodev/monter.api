...
def lambda_handler(event, context):
    ...
    if is_exist_user:
        raise MonterException(CommonResultCode.RESOURCE_ALREADY_EXIST, None, "해당")
    ...
    insert_query_result = pg_util.execute_and_returning_query(query_insert_new_user, (name, password))
